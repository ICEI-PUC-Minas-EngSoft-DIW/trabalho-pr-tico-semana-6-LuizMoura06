...
- Breve descrição sobre seu projeto:O projeto consiste no desenvolvimento da home-page de um site para o Hotel Vitória, localizado em Buenópolis. A página apresenta informações sobre o hotel, galeria de imagens, seção de fundadores e contato.

Nesta etapa, a responsividade foi implementada utilizando o framework Bootstrap, substituindo o uso de media queries, flexbox e grid do CSS puro.

## Print da versão responsiva com Bootstrap [DESKTOP]

![Desktop](public/image/desktop2.png)

## Print da versão responsiva com Bootstrap [MOBILE] (*)

![Mobile](public/image/mobile2.png)
